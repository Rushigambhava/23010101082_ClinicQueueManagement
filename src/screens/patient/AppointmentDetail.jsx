  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1><EventNoteIcon style={{ verticalAlign: "middle", marginRight: 8 }} />Appointment Details</h1>
          <p>Appointment #{apt?.id || apt?._id || id}</p>
        </div>
        <Link to="/appointments" className="btn btn-secondary"><ArrowBackIcon fontSize="small" /> Back</Link>
      </div>
      ...
      <div className="card" style={{ marginBottom: 20 }}>
        <div className="card-header">
          <h3><MedicationIcon style={{ verticalAlign: "middle", marginRight: 6, fontSize: 20 }} /> Prescription</h3>
        </div>
        {apt?.prescription ? (
          <div>
          ...
          <div className="empty-state" style={{ padding: 24 }}>
            <InboxIcon style={{ fontSize: 32, color: "var(--gray-300)" }} />
      ...
      <div className="card">
        <div className="card-header">
          <h3><DescriptionIcon style={{ verticalAlign: "middle", marginRight: 6, fontSize: 20 }} /> Report</h3>
        </div>
        {apt?.report ? (
          <div className="detail-grid">

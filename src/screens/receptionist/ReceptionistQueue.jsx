...
const ReceptionistQueue = () => {
  ...
  // Helper to extract patient name from various possible shapes
  ...
  return (
    <div>
      <div className="page-header">
        <div>
          <h1><ListAltIcon style={{ verticalAlign: "middle", marginRight: 8 }} />Daily Queue</h1>
          <p>Manage patient queue for the selected date</p>
        </div>
